...
extension BuildContextEntension<T> on BuildContext {
  ...
  Future<T?> navigatorPopandPushReplacementNamed(String routeName,
      {Object? arguments}) async {
  ...
  bool get isTablet =>
      MediaQuery.sizeOf(this).width < 900.0 ;
  ...
  //           child: SizedBox(
  //             height: 180,
  //             child: LottieBuilder.asset("assets/lottie/bus_loading.json",repeat: true,fit: BoxFit.contain,frameRate: const FrameRate(240),)));
  //     },
  //   );
  // }
}
